...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('102X_upgrade2018_realistic_v11'),
...
process.schedule = cms.Schedule(*[ process.lhe_step, process.generation_step, process.genfiltersummary_step, process.simulation_step, process.endjob_step, process.RAWSIMoutput_step, process.LHEoutput_step ], tasks=[process.patAlgosToolsTask])
